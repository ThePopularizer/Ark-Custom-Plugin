...
class UltimatumMenu extends WP_Widget {
	function __construct() {
        parent::__construct(false, $name = 'Ultimatum Menu');
    }
...
function register_UltimatumMenu(){
	register_widget( 'UltimatumMenu' );
}

add_action( 'widgets_init', 'register_UltimatumMenu' );
