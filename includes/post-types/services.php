...
if ( (!$option) || (!in_array('services', $option)) ) {
	return;
}
...
if ( ! function_exists( 'services_category' ) ) {
...
function services_excerpt( $translation, $original ) {
    if ( 'Excerpt' == $original ) {
        return 'Services Excerpt';
    }else{
...
add_filter( 'gettext', 'services_excerpt', 20, 3 );
