...
if ( (!$option) || (!in_array('testimonials', $option)) ) {
	return;
}
...
if ( ! function_exists( 'textimonials_taxonomy' ) ) {

// Register Custom Taxonomy
function textimonials_taxonomy() {
	...
	register_taxonomy( 'testimonials-cat', array( 'testimonials' ), $args );

}
add_action( 'init', 'textimonials_taxonomy', 0 );
